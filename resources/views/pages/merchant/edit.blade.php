        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edit Merchant
                    </h4>
                </div><!-- end card header -->

                <div class="card-body">
                    <p class="text-muted">Edit new Merchant
                    </p>
                    @if (session('success'))
                    ...
                    <div class="live-preview">
                        <form action="{{ route('manage-merchants.update', $merchant->id) }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="keeper_id" class="form-label">Merchant Keeper</label>
                                <select class="form-control @error('keeper_id') is-invalid @enderror" name="keeper_id"
                                    id="keeper_id">
                                    <option value="">--Select Keeper--</option>
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}"
                                            {{ old('keeper_id', $merchant->keeper_id) == $user->id ? 'selected' : '' }}>
                                            {{ $user->name }}</option>
                                    @endforeach
                                </select>
                                @error('keeper_id')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                        ...
                                        value="{{ old('phone', $merchant->phone) }}" oninput="formatPhone(this)">
                            ...
                            <div class="mb-3">
                                <label for="address" class="form-label">Merchant location</label>
                            ...
                            <div class="mb-3">
                                ...
                                @enderror
                                <div>
                                    <img src="{{ $merchant->photo }}" id="preview-photo"
                                        style="display:none; max-width:200px; margin-top:10px;" />
                                </div>
                            </div>
                            <div class="text-end">
                                <a href="{{ route('manage-merchants.index') }}" class="btn btn-dark me-2">Cancel</a>
